# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-06-02 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2016, 6, 2, 19, 15, 53, 447379))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime.now)),
                ('changed_at', models.DateTimeField(default=datetime.datetime.now)),
                ('duration', models.DurationField(choices=[(datetime.timedelta(0, 7200), '2:00'), (datetime.timedelta(0, 16200), '4:30'), (datetime.timedelta(0, 14400), '4:00'), (datetime.timedelta(0, 3600), '1:00'), (datetime.timedelta(0, 5400), '1:30'), (datetime.timedelta(0, 10800), '3:00'), (datetime.timedelta(0, 9000), '2:30'), (datetime.timedelta(0, 12600), '3:30')], default=datetime.timedelta(0, 3600))),
        ...
        migrations.AlterUniqueTogether(
            name='request',
            unique_together=set([('reciever_content_type', 'reciever_object_id', 'sender_content_type', 'sender_object_id', 'type')]),
        ),
        migrations.AlterUniqueTogether(
            name='openinghours',
